...
const IconTreinamento = () => <svg className="w-16 h-16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>;


// --- DADOS DOS SERVIÇOS ---
// 2. Adicionada a propriedade 'href' para cada serviço
const servicesData = [
  { href: "/servicos/ProgramaRecuperaçãoGerencial", title: ["Gestão", "de fazendas"], icon: <IconGestao /> },
  { href: "/servicos/PlanejamentoEstrategico", title: ["Planejamento", "estratégico"], icon: <IconPlanejamento /> },
  { href: "/servicos/DiagnosticoGlobal", title: ["Diagnóstico de", "Desempenho Global"], icon: <IconConsultoria /> },
  { href: "/servicos/AnalisePlanoDeNegocio", title: ["Plano de Aquisição", "de Fazendas"], icon: <IconDiagnostico /> },
  { href: "/servicos/DesenvolvimentoGerencial", title: ["Treinamento", "de equipes"], icon: <IconTreinamento /> },
];
