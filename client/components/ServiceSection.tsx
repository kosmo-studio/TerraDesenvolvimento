...
// A importação do 'Link' foi removida, pois não é mais necessária.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {servicesData.map((service) => (
            <div 
              ...
              className="bg-terra-dark-blue rounded-3xl p-6 text-center text-white flex flex-col items-center group transition-all duration-300 ease-in-out hover:bg-terra-navy hover:scale-105 hover:shadow-lg"
            >
