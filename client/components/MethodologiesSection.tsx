    ...
    <section className="p-4 lg:p-8">
      <div className="relative rounded-3xl overflow-hidden w-full min-h-[600px] lg:h-[75vh] flex items-center">
        ...
        <div className="relative z-10 p-8 md:p-16 w-full">
          {/* Alinhamento geral no topo para corresponder à imagem */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-48 max-w-7xl mx-auto text-terra-navy">
